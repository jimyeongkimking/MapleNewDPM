...
class1 <- c("Warrior", "Warrior", "Warrior", "Wizard", "Wizard", "Wizard", "Bowman", "Bowman", "Bowman",
            ...
            "Warrior", "Bowman", "Thief", "Pirate", "Warrior", "Wizard", "Thief", "Pirate", "Wizard", "Thief", "Warrior", "Wizard") #칼리 2023-10-09 추가

class2 <- c(rep("Adventure", 15), rep("CygnusKnights", 6), rep("Heroes", 6), rep("Resistance", 5), rep("Demon", 2), 
            rep("Nova", 4), rep("Lef", 4), rep("Anima", 2), "Transcedent", "Supernatural") #칼리 2023-10-09 추가 
...
MainStat <- c("STR", "STR", "STR", "INT", "INT", "INT", "DEX", "DEX", "DEX", "LUK", "LUK", "LUK", "STR", "DEX", "STR",
              ...
              "STR", "DEX", "LUK", "DEX", "STR", "INT", "LUK", "STR", "INT", "LUK", "STR", "INT") #칼리 2023-10-09 추가 
...
SubStat1 <- c("DEX", "DEX", "DEX", "LUK", "LUK", "LUK", "STR", "STR", "STR", "DEX", "DEX", "DEX", "DEX", "STR", "DEX", 
              ...
              "DEX", "STR", "DEX", "STR", "DEX", "LUK", "DEX", "DEX", "LUK", "DEX", "DEX", "LUK") #칼리 2023-10-09 추가 

SubStat2 <- c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "STR", "STR", NA, NA, NA, 
              NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
              NA, NA, NA, NA, "STR", NA, NA,
              NA, NA, "STR", NA, NA, NA, NA, NA, NA, NA, NA, NA) #칼리 2023-10-09 추가 
...
BaseMastery <- c(20, 20, 20, 25, 25, 25, 15, 15, 15, 
                 ...
                 20, 15, 20, 15, 20, 20, 20, 20, 25, 20, 20, 20) #칼리 2023-10-09 추가 - 칼리 기본 마스터리 20
