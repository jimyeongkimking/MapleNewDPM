...
# 10월 9일 여명 및 에테르넬 추가 / 칼리 무기도 / 칼리 보조 / 어센틱 심볼 도원경 아르테리아 카르시온 / 시드링 5렙
...
Guadian <- c(160, 5, 5, 5, 200, 0, 2, 2, 0, 0, 2, F, F, 10, F, 0, 0, 0, 0) #10월 9일 가엔링 추가
...
Daybreak <- c(140, 8, 8, 8, 0, 5, 2, 2, 0, 0, 5, T, T, 10, F, 0, 0, 0, 0) #10월 9일 데브펜 추가
...
{Newbie <- rbind(item[[1]][1, ], item[[1]][2, ], item[[1]][5, ], item[[1]][5, ],
                 ...
                 item[[20]][4, ], item[[20]][5, ]) #10월 15일 여기까지 완
...
##여기선 함수 세팅이 필요하므로, 나중에 다시 파악하는 것으로 한다. 11월 1일
...
## Final Item Specs (Newbie) - 데이터프레임 기준 밑으로 아이템 정렬 순서 / SpecSet1[1, 11] 여기에서 11은 뭘 의미? / c(3, 3, 3) 숫자의 개수는 업횟인 거 알겠는데, 3은 뭐지? / 물어보자
{SpecSet1 <- Newbie
Up <- data.frame()
